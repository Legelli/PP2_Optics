...
\section{Appendice}
\begin{center}
\captionof{table}{Misure per lo studio della funzione di correlazione.}
\label{tab:intensita}
...
\hline
\end{tabular}
\footnotetext{Come indicato nella Sezione~\ref{sec:presa_dati}, questa misura è effettuata con distanza tra lo specchio mobile e il beamsplitter di $d_\mathrm{mobile} = \SI{5.6 \pm 0.1}{cm}$.}
\end{center}
